...
<div
  class="content-cardgrid<?php if ($options->margin_top) : echo ' spacing-top'; endif; ?><?php if ($options->margin_bottom) : echo ' spacing-bottom'; endif; ?><?php if ($options->theme_mode) : echo ' theme' . $options->theme_mode; endif; ?>">
  <div class="contain-xxl">
    <div class="<?php if ($options->container_width) : echo 'contain-' . $options->container_width; endif; ?>">

      <div class="content-cardgrid-container">

        <?php
          $uploads = wp_upload_dir();
          foreach($section1 as $card) :
        ?>
        <div class="content-cardgrid-item">
          <?php if (isset($card->link['url'])) : ?>
          <a class="card" href="<?php echo $card->link['url']; ?>">
            <?php else : ?>
            <div class="card">
              <?php endif; ?>
