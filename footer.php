...
<footer id="colophon" class="site-footer has-dark-bg contain-xxl">

    <!-- Default footer content that you can safely remove from here... -->
    <div class="site-info contain-xl">
        <a class="no-text-link powered-by-wordpress"
            href="<?php echo esc_url( __( 'http://wordpress.org/', 'fewcrew' ) ); ?>">
            <svg class="wordpress-logo" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="42" height="42"
            ...
            <span>
                <?php printf( esc_html__( 'Proudly powered by %s', 'fewcrew' ), 'WordPress' ); ?>.
            </span>
        </a>
        <span class="theme-info">
            <?php printf( esc_html__( 'Lightweight like %1$s itself. You are using version %2$s', 'fewcrew' ), '<i>air</i>', esc_attr( Few_Crew_VERSION ) ); ?>
            <a class="no-text-link github-link"
                href="<?php echo esc_url( __( 'https://github.com/digitoimistodude/air', 'fewcrew' ) ); ?>">
...
<a href="#page" id="top" class="top no-external-link-indicator"
    data-version="<?php echo esc_attr( Few_Crew_VERSION ); ?>">
