...
<footer id="colophon" class="site-footer has-dark-bg contain-xxl">
  ...
  <div class="site-info contain-xl">
    <a class="no-text-link powered-by-wordpress" href="<?php echo esc_url( __( 'http://wordpress.org/', 'fewcrew' ) ); ?>">
    ...
    <span class="theme-info">
      ...
      <a class="no-text-link github-link" href="<?php echo esc_url( __( 'https://github.com/digitoimistodude/air', 'fewcrew' ) ); ?>">
