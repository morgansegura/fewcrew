...
<footer id="colophon" class="site-footer has-dark-bg">
  ...
  <div class="site-info">
    ...
    <span class="theme-info">
      <?php printf( esc_html__( 'Lightweight like %1$s itself. You are using version %2$s', 'fewcrew' ), '<i>air</i>', esc_attr( FewCrew_VERSION ) ); ?>
...
<a
  ...
  data-version="<?php echo esc_attr( FewCrew_VERSION ); ?>"
>
