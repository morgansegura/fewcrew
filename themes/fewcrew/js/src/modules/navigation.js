...
;(function ($) {
  ...
  $('.menu-item a, .dropdown button').on('keyup', function (e) {
    ...
    if (isSubMenuDropdownOpen === 'true' || isMainMenuDropdownOpen === 'true') {
      if ($('.dropdown').find(':focus').length !== 0) {
        ...
        if (e.code === 'Escape') {
          ...
          // jscs:enable
          screenReaderSpan.text(FewCrew_screenReaderText.expand)
    ...
    if (window.innerWidth > responsivenav) {
      ...
      screenReaderSpanPrev.text(FewCrew_screenReaderText.expand)
  ...
  $('.dropdown-toggle').each(function () {
    $(this).attr(
      'aria-label',
      `${FewCrew_screenReaderText.expand_for} ${$(this).prev().text()}`
    )
  })
  ...
  siteHeaderMenu.find('.dropdown-toggle').on('click', function (e) {
    ...
    $(this).attr(
      ...
      $(this).attr('aria-label') ===
        `${FewCrew_screenReaderText.collapse_for} ${$(this).prev().text()}`
        ? `${FewCrew_screenReaderText.expand_for} ${$(this).prev().text()}`
        : `${FewCrew_screenReaderText.collapse_for} ${$(this).prev().text()}`
    )
  })
  ...
  function mobileNav() {
    ...
    menuToggle.on('click', function () {
      ...
      $('#nav-toggle-label').text(
        ...
        $('#nav-toggle-label').text() === FewCrew_screenReaderText.expand_toggle
      ...
      $(this).attr(
        'aria-label',
        $(this).attr('aria-label') === FewCrew_screenReaderText.expand_toggle
          ? FewCrew_screenReaderText.collapse_toggle
          : FewCrew_screenReaderText.expand_toggle
      )
