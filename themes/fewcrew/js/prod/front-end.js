;(() => {
  ...
  ;(n.n = e => {
    ...
    (() => {
      ...
      function i(e) {
        return void 0 === window.FewCrew_screenReaderText ||
          void 0 === window.FewCrew_screenReaderText[e]
          ? (console.error('Missing translation for '.concat(e)), '')
          : window.FewCrew_screenReaderText[e]
      }
      function a(e) {
        var t = o(e.children)
      ...
      function s() {
        ...
        void 0 !== window.FewCrew_externalLinkDomains &&
          (e = e.concat(window.FewCrew_externalLinkDomains))
      ...
      !(function (e) {
        ...
        if (
          (e('.menu-item a, .dropdown button').on('keyup', function (t) {
            ...
            if (
              ...
              i.find('.sub-menu').removeClass('toggled-on'),
                ...
                a.text(FewCrew_screenReaderText.expand),
            ...
            if (window.innerWidth > p) {
              ...
              d.find('.sub-menu').removeClass('toggled-on'),
                ...
                l.text(FewCrew_screenReaderText.expand)
              ...
              u.find('.sub-menu').removeClass('toggled-on'),
                ...
                g.text(FewCrew_screenReaderText.expand)
            }
          }),
          ...
          e('.dropdown-toggle').each(function () {
            e(this).attr(
              'aria-label',
              ''
                .concat(FewCrew_screenReaderText.expand_for, ' ')
            ...
            e(this).toggleClass('toggled-on'),
              ...
              e(this).attr(
                ...
                e(this).attr('aria-label') ===
                  ''
                    .concat(FewCrew_screenReaderText.collapse_for, ' ')
                    .concat(e(this).prev().text())
                  ? ''
                      .concat(FewCrew_screenReaderText.expand_for, ' ')
                      .concat(e(this).prev().text())
              ...
              w.on('click', function () {
                e(this).add(x).toggleClass('toggled-on'),
                  ...
                  e('#nav-toggle-label').text(
                    e('#nav-toggle-label').text() ===
                      FewCrew_screenReaderText.expand_toggle
                      ? FewCrew_screenReaderText.collapse_toggle
                      : FewCrew_screenReaderText.expand_toggle
                  ),
                  e(this).attr(
                    'aria-label',
        ...
        function E() {
          i.removeEventListener('keydown', _, !1),
            ...
            a.setAttribute('aria-expanded', 'false'),
            e('#nav-toggle-label').text(FewCrew_screenReaderText.expand_toggle),
            i.focus()
        }
        function L() {
