	...
	function fcunited_customizer_add_theme_vars( $vars ) {
		...
		if ( isset( $vars['page'] ) ) {
			if ( substr( $vars['page'], 0, 2 ) != '{{' ) {
				...
				$rez['page_boxed']       = fcunited_prepare_css_value( $vars['page'] + 2 * $vars['page_boxed_extra'] );
				$rez['content']          = fcunited_prepare_css_value( $vars['page'] - $vars['sidebar'] - $vars['gap'] );
				$rez['sidebar']          = fcunited_prepare_css_value( $vars['sidebar'] );
				$rez['gap']              = fcunited_prepare_css_value( $vars['gap'] );
				$rez['sidebar_gap']      = fcunited_prepare_css_value( $vars['sidebar'] + $vars['gap'] );
