...
if ( ! function_exists( 'fcunited_gutenberg_add_theme_vars' ) ) {
	add_filter( 'fcunited_filter_add_theme_vars', 'fcunited_gutenberg_add_theme_vars', 10, 2 );
	function fcunited_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'fcunited_gutenberg_get_css' ) ) {
	add_filter( 'fcunited_filter_get_css', 'fcunited_gutenberg_get_css', 10, 2 );
	function fcunited_gutenberg_get_css( $css, $args ) {
