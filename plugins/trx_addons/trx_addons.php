...
// Current version
if ( ! defined( 'TRX_ADDONS_VERSION' ) ) define( 'TRX_ADDONS_VERSION', '1.6.57.4' );
...
if ( !function_exists( 'trx_addons_load_scripts_admin' ) ) {
	...
	function trx_addons_load_scripts_admin($all=false) {
		...
		if( is_rtl() ) {
			wp_enqueue_style( 'trx-addons-rtl', trx_addons_get_file_url( 'css/trx_addons.rtl.css' ), array(), null );
		}
