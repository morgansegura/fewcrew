  ...
  public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
    ...
    $output .= apply_filters( 'walker_nav_menu_start_el', $item_output, $item, $depth, $args );
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a target="_blank" href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'fewcrew' ) . '">' . esc_html__( 'Add a menu', 'fewcrew' ) . '</a></li>';
			$fallback_output .= '</ul>';
