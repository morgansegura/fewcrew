  ...
  module: {
    rules: [
      ...
      },
      {
        test: /\.svg$/,
        include: [
          paths.src.fontAwesomeFree,
          paths.src.fontAwesomePro,
          paths.src.svg,
        ],
        use: [
          {
            ...
            options: {
              ...
              spriteFilename: (path) => {
                ...
                const isFontAwesomeFree =
                  path.indexOf("fontawesome-free") !== -1;
        ...
        test: [
          {
            ...
            method: (path) => {
              ...
              return (
                file.startsWith("styles_") ||
                file.startsWith("lang_") ||
                file.startsWith("assets_")
              );
            },
            recursive: true,
          },
